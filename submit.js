...
let answerSheet = JSON.parse(localStorage.getItem('answerPDF')) || []
...
for (let i = 0; i < Questions.length; i++) {
 ...
 resultarray =  answerSheet.filter((answer)=>{
if(answer["QuestionId"] == Questions[i]["QuestionId"]&& answer["Option"] == Questions[i]["answer"]){
result.push(i)
...
let point =  parseFloat((result.length/25)*100);
points.innerHTML =`${(point).toFixed(2)}%` 
...
} else if (result.length >= 6 && result.length <= 10) {
    image.src = "tier2.png";
} else if (result.length >= 11 && result.length <= 15) {
    image.src = "tier3.png";
} else if (result.length >= 16 && result.length <= 20) {
    image.src = "tier4.png";
} else if (result.length >= 21 && result.length <= 25) {
    image.src = "tier5.png";
} else {
...
stars.forEach((star, index) => {
    if (result.length >= 1) {
        if (result.length < 5) {
            stars[0].style.background = `linear-gradient(to right, #FFC956 ${Math.floor((5- result.length) / 5 * 100)}%, #6F46AE 1%)`;
            stars[0].style.webkitBackgroundClip = 'text'
            stars[0].style.color = "transparent"
         
            
        } else {
            stars[0].style.webkitBackgroundClip = '';
            stars[0].style.color = "#FFC956";
    ...
    if (result.length > 5) {
        if (result.length < 10) {
            stars[1].style.background = `linear-gradient(to right, #FFC956 ${Math.floor((result.length - 5) / 5 * 100)}%, #6F46AE 1%)`;
            stars[1].style.webkitBackgroundClip = 'text'
            stars[1].style.color = "transparent"
           
        } else {
 
            stars[1].style.color = "#FFC956";
    ...
    if (result.length > 10) {
        if (result.length < 15) {
            stars[2].style.background = `linear-gradient(to right, #FFC956 ${Math.floor((result.length - 10) / 5 * 100)}%, #6F46AE 1%)`;
            stars[2].style.webkitBackgroundClip = 'text'
stars[2].style.color = "transparent"
         
           
        } else {
           stars[2].style.webkitBackgroundClip = '';
            stars[2].style.color = "#FFC956";
    ...
    if (result.length > 15) {
        if (result.length < 20) {
            stars[3].style.background = `linear-gradient(to right, #FFC956 ${Math.floor((result.length - 15) / 5 * 100)}%, #6F46AE 1%)`;
            stars[3].style.webkitBackgroundClip = 'text'
stars[3].style.color = "transparent"
           
        } else {
           stars[3].style.webkitBackgroundClip = '';
            stars[3].style.color = "#FFC956";
    ...
    if (result.length > 20) {
        if (result.length < 25) {
            stars[4].style.background = `linear-gradient(to right, #FFC956 ${Math.floor((result.length - 20) / 5 * 100)}%, #6F46AE 1%)`;
            stars[4].style.webkitBackgroundClip = 'text'
stars[4].style.color = "transparent"
        } else {
           stars[4].style.webkitBackgroundClip = '';
            stars[4].style.color = "#FFC956";
        }
    }
});
